 ...
 */
public class Pages {
    private static final int cakePrice = 200;
    private static final int creamPrice = 100;
    ...
    private static final OrderObject [] weightObjects = {
            new OrderObject(R.drawable.button_bg, "0.5 Kg Cake - Rs. 600", 200),
            new OrderObject(R.drawable.button_bg, "1 Kg Cake - Rs. 1100", 700),
            new OrderObject(R.drawable.button_bg, "1.5 Kg Cake - Rs. 1500", 1100),
            new OrderObject(R.drawable.button_bg, "2 Kg Cake - Rs. 1800", 1400),
            new OrderObject(R.drawable.button_bg, "3 Kg Cake - Rs. 2800", 2400)
    };
    ...
    private static final OrderObject [] shape = {
            new OrderObject(R.drawable.button_bg, "Circle: Rs. 100", 100),
            new OrderObject(R.drawable.button_bg, "Square: Rs. 150", 150),
            new OrderObject(R.drawable.button_bg, "Heart: Rs. 200", 200),
            new OrderObject(R.drawable.button_bg, "Others: Rs. 500", 400)
    };
    public static final OrderPage shapePage =
            new OrderPage("Select The Shape of Your Cake", shape);
    public static final int [] deliverPics = {
            R.drawable.deliver
    };
}
